...
1. **Buy newer, low-mileage cars whenever possible.** These are your bread and butter — age and miles are the two biggest price drivers by far.

2. **Make room for diesel pickups and SUVs.** They consistently sell at higher prices and are worth the investment to acquire.

3. **Spend money on detailing and reconditioning.** Getting a car from "good" to "excellent" condition pays for itself in the higher sale price.
